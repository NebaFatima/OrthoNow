/**
 * OrthoNow — dataLayer Manager
 * File: tracking.js
 * Version: 1.0.0
 *
 * Centralized module for all dataLayer pushes on the OrthoNow site.
 * Front-end developers call typed functions instead of raw
 * window.dataLayer.push() to keep event names and payloads consistent.
 *
 * Usage:
